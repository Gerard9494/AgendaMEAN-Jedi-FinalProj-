...
* Added socketTimeoutMS and connectTimeoutMS to socket options for repl_set.js and index.js
...
* Correctly emit errors from index.js only wrapping errors that are strings
